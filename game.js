...
function checkSubBoardWinner(mainCellIndex) {
  ...
  for (let condition of winConditions) {
    ...
    if (
      ...
      mainGameState[mainCellIndex] = currentPlayer;
      return true;
    }
  }
  return false;
...
function handleSubCellClick(event) {
  ...
  if (checkSubBoardWinner(mainCellIndex)) {
    ...
    if (winner) {
      ...
      // Handle the main board win (display message, end game, etc.)
    }
  }

  lastPlayedCell = subCellIndex; // Update last played cell for game rules
